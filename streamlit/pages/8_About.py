...
def main():
    ...
    with tech_tab:
        ...
        <div class="info-card">
            ...
            <div style="background: rgba(15, 23, 42, 0.8); border-radius: 8px; padding: 1rem; margin: 1rem 0; font-family: monospace; font-size: 0.85rem; color: #e2e8f0;">
                Input Features (varying dimensions per node type)<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                Linear Projection → hidden_dim (64)<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                ReLU Activation<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                HeteroConv Layer 1 (SAGEConv per edge type) → hidden_dim<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                ReLU + Dropout (0.3)<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                HeteroConv Layer 2 (SAGEConv per edge type) → out_dim (32)<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;↓<br/>
                Node Embeddings (used for link prediction + risk scoring)
            </div>
            
            <p style="margin-top: 1rem;"><strong>Key Design Choices:</strong></p>
            <ul style="color: #94a3b8;">
